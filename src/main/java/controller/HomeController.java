...
public class HomeController implements Controller {     // Get에만 응답하는 친구 입니다.
    ...
    public boolean doesFit(StartLine startLine) {   // startLine의 HTTP version은 몰라유.. 어케 처리 함?
        return startLine.isMatchingPath("/", "/index.html"); // TODO: 얘 하드 코딩 바꾸자, 한 곳에서 관리 하고 싶어..? 그냥 뭔가 맘에 안드어 ㅗ
    }

    @Override
    public byte[] runLogic(BufferedReader br, DataOutputStream dos, StartLine startLine) {
